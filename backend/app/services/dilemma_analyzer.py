...
class DilemmaAnalyzer:
    ...
    async def analyze_dilemma(
        ...
        user = (
            ...
            "1. СУТЬ ВЫБОРА (1-2 предложения — что на самом деле решается)\n"
            "2. ВАРИАНТЫ (каждый вариант с плюсами и минусами на основе реальных данных)\n"
            "3. КОНТЕКСТ (что из жизни пользователя влияет на это решение — конкретные цифры и факты)\n"
            "4. РЕКОМЕНДАЦИЯ (один конкретный совет с объяснением)\n"
        )
