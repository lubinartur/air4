...
_CHAT_AGENT_INSTRUCTIONS: dict[str, str] = {
    "finance": (
        ...
        "Следуй правилу «обсуждение до рекомендации»: сначала наблюдение и один вопрос "
        "о причине, потом варианты, потом рекомендация с обоснованием. "
    ...
    "projects": (
        ...
        "застое, следующих шагах и распылении. Не советуй сразу — сначала озвучь "
        "наблюдение, задай один конкретный вопрос о причине, потом предложи 2–3 "
        "варианта и рекомендацию с обоснованием под его паттерны."
    ),
    "health": (
        ...
        "При проблемах сначала выясни причину одним точным вопросом — не выдавай "
        "план тренировок до понимания контекста."
    ),
}
